  ...
  en: {
    translation: {
      ...
      checker: {
        ...
        result_dpi: 'Resolution (DPI)', result_file_size: 'File Size', result_image_width: 'Image Width', result_file_format: 'File Format',
      },
      converter: {
