export default function JournalPage(){
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      <h1 className="text-3xl font-bold">Science Figure Requirements</h1>
      <div className="mt-4 text-gray-700">
        <div><b>Recommended DPI:</b> 300</div>
        <div><b>Common widths:</b> 84 mm / 178 mm</div>
        <div className="mt-3"><b>Notes:</b> Panels labeled A, B, C. Avoid embedded raster text.</div>
      </div>
